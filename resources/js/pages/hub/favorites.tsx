...
export default function FavoritesPage() {
    ...
    return (
        <div className="p-6 lg:p-8">
            <div className="mb-8">
                <h1 className="mb-2 text-2xl font-bold lg:text-3xl">Kreator Favorit</h1>
                <p className="text-muted-foreground">Kreator yang Anda simpan</p>
            </div>

            <p className="mb-6 text-sm text-muted-foreground">
                {creators.length} kreator favorit
            </p>
            ...
            {creators.length > 0 ? (
                    ...
                    {creators.map((creator) => (
                        ...
                        >
                            ...
                            <CardFooter className="flex items-center justify-between p-4 pt-0">
                                ...
                                >
                                    <Link href={`/creator/${creator.username}`}>Komisi</Link>
                                </Button>
                            </CardFooter>
                        </Card>
                    ))}
                ...
                <div className="py-16 text-center">
                    ...
                    <h3 className="mb-2 text-xl font-semibold">Belum ada favorit</h3>
                    <p className="mx-auto mb-6 max-w-md text-muted-foreground">
                        Jelajahi kreator dan simpan favorit Anda untuk menemukannya dengan mudah.
                    </p>
